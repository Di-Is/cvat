...
CVAT_FUNCTION_INTERACT_TIMEOUT = int(os.getenv("CVAT_FUNCTION_INTERACT_TIMEOUT", 30))
CVAT_FUNCTION_TRACKER_DEFAULT_BATCH_SIZE = int(
    os.getenv("CVAT_FUNCTION_TRACKER_DEFAULT_BATCH_SIZE", 16)
)
CVAT_FUNCTION_TRACKER_MAX_BATCH_SIZE = int(os.getenv("CVAT_FUNCTION_TRACKER_MAX_BATCH_SIZE", 32))
MAX_CONCURRENT_INTERACT_WAIT = int(os.getenv("CVAT_MAX_CONCURRENT_INTERACT_WAIT", 12))
